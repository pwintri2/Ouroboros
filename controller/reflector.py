...
class Reflector:
    ...
    def evaluate_action(self, task_name, result_raw_output, expected_outcome=None):
        ...
        if any(keyword in output_lower for keyword in ["error", "traceback", "exception", "failed", "permission denied", "access denied", "operation not permitted", "timeout", "time-out", "fout", "mislukt", "gecrasht"]) or \
