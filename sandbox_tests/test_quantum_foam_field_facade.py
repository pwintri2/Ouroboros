...
class TestQuantumFoamFieldFacade(unittest.TestCase):
    ...
    def test_local_field_spawns_nonlocal_mesh_and_releases_nodes_on_collapse(self):
        ...
        self.assertEqual(active_snapshot["dimensional_geometry"]["dimension"], 1)
        self.assertEqual(active_snapshot["dimensional_geometry"]["visual_model"], "line_segment")
        self.assertTrue(active_snapshot["dimensional_geometry"]["electron_clique"]["all_to_all_connected"])
        ...
        self.assertIn("dimensional_geometry", field.last_collapse)
    ...
    def test_agentic_event_uses_v49_runtime_and_collapses_after_task(self):
        ...
        self.assertIn("dimensional_geometry", start)
        self.assertEqual(start["active_dimension"], 1)
